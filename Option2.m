%This function creates the output from the combiner presented as Option #2 in the report Individual project task 4

function combiner_output = Option2(initial_states,feedback_polynomials,length)
...
for i=1:length
    ...
    combiner_output(i,1)=mod(sum(1+output_bit3+output_bit2+and(output_bit2,output_bit3)+output_bit1+and(output_bit1,output_bit3)+and(output_bit1,output_bit2)),2);
